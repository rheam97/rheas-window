...
export default function StainedGlass() {
  return (
    <div
      id="projects"
      className="grid max-h-screen h-[calc(100vh-48px)] sm:h-[calc(100vh-40px)]  md:h-[calc(100vh-130px)] lg:grid-cols-4 lg:grid-rows-3 grid-cols-3 grid-rows-4 bg-gradient-to-b from-cyan-500 via-pink-300 to-orange-500  border-black"
    >
