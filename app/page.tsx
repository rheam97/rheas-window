...
function Tile (props:any){
  ...
  return (
    <>
    <div onClick={()=>setShow(true)} className={`border-solid border-4 relative border-black bg-gradient-to-b ${props.color} to-transparent rounded-2xl blur-sm lg:min-h-[16rem] 2xl:min-h-[27rem] min-h-[9rem] ${props.project ? `${props.project} bg-cover hover:filter-none active:filter-none` : `hover:filter-none active:filter-none`} transition-filter ease-in-out duration-700`}>
...
function StainedGlass(){  
    ...
    return (
      <div id='projects' className="grid sm:h-full md:h-[875px] lg:h-full lg:grid-cols-4 grid-cols-3 bg-gradient-to-b from-cyan-500 via-pink-300 to-orange-500 lg:border-t-[220px] border-t-100 border-black" >
