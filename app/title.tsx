...
function Title(){
    ...
    <div className="h-screen bg-black max-w-screen container flex flex-col align-center justify-center">
        <h1 className='relative py-3 px-5 bg-gradient-to-r from-pink-400 via-yellow-300 to-green-400 bg-clip-text font-extrabold sm:text-8xl text-transparent text-2xl
